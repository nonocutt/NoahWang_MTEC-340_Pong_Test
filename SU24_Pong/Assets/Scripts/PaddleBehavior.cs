...
public class NewBehaviourScript : MonoBehaviour
{
    ...
    // private is default modifier
    // SerializeField is private but visible in the inspector
    ...
    private void Start()
    {
        ...
        float heightInUnits = cam.ScreenToWorldPoint(new Vector3(0, cam.pixelHeight, 0)).y;
